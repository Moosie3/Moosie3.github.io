...
// Directory where ETS2 modpacks are stored
$modpacksDir = "D:/FBowers/Server stuff/WEBHOST/Hostingtools/XAMPP/htdocs/modpacks/Euro Truck Simulator 2/";
...
if (isset($_GET['file'])) {
    ...
    if (file_exists($filePath)) {
        ...
        if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
            ...
            $message = "<@485553416521908255> User **$username** has just downloaded **$file** from ETS2.";
